...
// the `tv_displays` mobile permission. Studio music gates on `device_control`
// (cross-platform since SONOSMOB.2 — the same key the `/api/sonos/*` routes
// enforce). Reached from the Studio tile in More (or the bottom bar if
// pinned there).
