...
describe('normalizeOtpInput', () => {
  it('keeps every digit of an emailed code (a 6-cap truncated it and sign-in could never succeed)', () => {
...
describe('isCompleteOtp', () => {
  it('is false at six digits — a partial code must not enable the verify button', () => {
