...
//   canQueue         — bookkeeper queue (INV-M.1)         (bookkeepers: `bookkeeper`, cross-platform)
//
...
export function accountingLanding({ canExpenses, canInvoices, canInbox, canCardReceipts, canOrders, canQueue } = {}) {
  const available = [
