...
5. **Run now** applies the current schedule immediately instead of waiting for the tick. It keeps three answers apart on purpose: *no schedule to apply*, *the schedule is switched off*, and *already correct*.
