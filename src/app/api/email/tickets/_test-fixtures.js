...
export const T_STUDIO = {
  ...
  subject: 'Class times', has_inbound: true, is_spam: false, status: 'open', priority: 'normal',
...
export const T_ACCOUNTS = {
  ...
  subject: 'Direct debit bounced', has_inbound: true, is_spam: false, status: 'open', priority: 'normal',
  assigned_to: null, first_response_at: null,
...
export const T_OTHER_LOCATION = {
  ...
  subject: 'Hatch enquiry', has_inbound: true, is_spam: false, status: 'open', priority: 'normal',
  assigned_to: null, first_response_at: null,
