...
const CreateSchema = z.object({
  ...
  // Mig 145 (GLOFOX3.3): when true, public registrations push every
  // team member to Glofox (search-and-link OR create + attach trial).
  // See /api/public/events/[slug]/register for the call site.
