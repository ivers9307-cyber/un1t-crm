...
export default async function PersonalDashboardPage() {
  ...
  const { weekShifts, weekStartIso, weekEndIso, shiftsThisWeek, hoursThisWeek, pendingSwapsForMe, myPendingTimeOff, unreadInbox } = res.data
  ...
  return (
    <>
      ...
      <div className="bg-un1t-dark border border-un1t-gray rounded-2xl mb-4 max-w-2xl overflow-hidden">
        <div className="px-4 pt-3 pb-2 flex items-baseline justify-between">
          <span className="text-xs font-semibold uppercase tracking-wider text-un1t-light">This week</span>
          <span className="text-xs text-un1t-mid">{rangeLabel}</span>
        </div>
