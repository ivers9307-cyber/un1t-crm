    ...
    <div className="p-6 max-w-4xl">
      ...
      {!data.pinned ? (
        ...
        <>
          ...
          {/* Invoices — empty state only in v1 (no invoice tables exist
              yet; the Stripe/C2b leg creates them). */}
          <div className="mb-10">
            ...
            <div className="bg-un1t-surface border border-un1t-border rounded-lg p-6 text-sm text-un1t-subtle">
              Top-up and subscription invoices will appear here.
            </div>
          </div>

          {/* Billing contact — no storage columns exist yet (no
              migration in this item by design); fields render disabled
              until the billing-contact columns land with the Stripe leg. */}
          <div>
            ...
            <div className="bg-un1t-surface border border-un1t-border rounded-lg p-4">
              ...
              <p className="text-xs text-un1t-subtle mt-3">
                Coming soon — billing contact details ship with card top-ups and invoicing.
              </p>
            </div>
          </div>
        </>
