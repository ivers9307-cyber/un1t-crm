  ...
  return (
    <div className="p-8 max-w-4xl">
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center gap-3">
                <Activity size={16} className="text-un1t-subtle shrink-0" />
                <div>
                  <div className="text-un1t-text">Integration health</div>
                  <div className="text-xs text-un1t-subtle mt-0.5">
                    One pane showing whether anything is silently broken — scheduled jobs, the WhatsApp number, and webhook processing, each with a red/amber/green status.
                  </div>
                </div>
              </div>
              <ChevronRight size={16} className="text-un1t-subtle group-hover:text-un1t-text shrink-0" />
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-un1t-text">Public status page</div>
                  <div className="text-xs text-un1t-subtle mt-0.5">
                    The member-facing status page — edit the wording for each service and state. Members see a plain-language operational / degraded status, never internal detail.
                  </div>
                </div>
              </div>
              <ChevronRight size={16} className="text-un1t-subtle group-hover:text-un1t-text shrink-0" />
      ...
      {/* Billing (INTEG-D1) — the tenant Billing & usage page. Owner/
          ...
          its own server gate regardless). Pinning-gated inside: an org
          with no platform plan sees a quiet empty state. */}
      {(user.role === 'owner' || user.role === 'master') && (
        <div className="mb-10">
          <div className="flex items-center gap-2 mb-4">
            <CreditCard size={18} className="text-un1t-subtle" />
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center gap-3">
                <CreditCard size={16} className="text-un1t-subtle shrink-0" />
                <div>
