// /races/[id]/teams — operator team-management view for a race.
//
...
export default async function RaceTeamsPage({ params }) {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <Link href="/races" className="inline-flex items-center gap-1.5 text-sm text-un1t-light hover:text-un1t-white mb-3">
