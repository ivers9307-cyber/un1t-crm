...
//
// Scope: /host-connect/[token] — self-serve Stripe onboarding for an event
// host. Partner-facing, reached from an emailed link.
...
export default function HostConnectLayout({ children }) {
  return children
}
