...
// working unchanged.
//
// Local imports (`contactMatchesSequenceAudience`, `enrolContacts`)
// are still used by the cron-driven runners + step handlers below;
// those move out in slices 3 + 4.
...
// triggerSequencesForStatusChange is also imported locally — it's
// chained from updateFieldStep when a step writes a contact field
// that's also a sequence trigger surface.
import { triggerSequencesForStatusChange } from './sequences/triggers.js'
export {
