...
registry.registerPath({
  ...
  responses: {
    ...
    403: { description: 'Deciding your own request, a status other than cancelled on your own request, no time-off approval permission, or (LEAVEGUARD.1) taking a manager-tier colleague\'s approved leave out of force without being an owner there or a master', content: { 'application/json': { schema: ErrorResponse } } },
