...
registry.registerPath({
  ...
  responses: {
    ...
    409: { description: 'Expired pending request; or own approved leave that has ended / has no other owner to approve its cancellation', content: { 'application/json': { schema: ErrorResponse } } },
  },
})
