...
export function buildExpansionPrompt({ week, slot = 1, dial = 'mixed', locationLabel = 'UN1T', charter, houseStyle, styleExamples, autoTuneSignal = null, arcPlan, sessionsPerWeek, prevWeekSummary } = {}) {
  ...
  const system = [
    ...
    '- board.stations[].performance and board.stations[].elite: a SINGLE short target value, a few words at most (aim for under 16 characters), like "400m", "100kg", "9kg x 20", "sub 2:10/500m", "20 reps". NEVER a coaching sentence, never nested objects.',
