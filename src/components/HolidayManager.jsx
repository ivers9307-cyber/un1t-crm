  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-un1t-dark border border-un1t-gray rounded-lg p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-un1t-light mb-3">Add Custom Holiday</h3>
        {error && (
        ...
        <form onSubmit={handleAdd} className="grid grid-cols-1 md:grid-cols-[180px_1fr_auto] gap-3 items-end">
          <div>
            <label className="block text-xs text-un1t-light mb-1">Date</label>
            <input
              type="date"
              value={date}
          ...
          <button
            type="submit"
            disabled={saving}
            className="inline-flex items-center gap-1.5 bg-un1t-white text-un1t-black px-4 py-2 rounded-md hover:bg-un1t-accent text-sm font-medium disabled:opacity-50"
          >
                ...
                <tbody className="divide-y divide-un1t-gray">
                  {list.map(h => (
                    <tr key={h.id || `static-${h.date}`} className="hover:bg-un1t-gray/20">
                      <td className="p-3 w-32 font-mono text-un1t-light text-xs">{h.date}</td>
                      <td className="p-3">
                      ...
                      <td className="p-3 w-12 text-right">
                        {h.source === 'custom' && (
                          <button
                            ...
                            className="text-un1t-mid hover:text-red-400"
