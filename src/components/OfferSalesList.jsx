            ...
            {pending.map((r) => (
              ...
              >
                ...
                <button
                  ...
                  disabled={busy === r.id}
                  className="shrink-0 px-4 py-2 rounded-md bg-un1t-text text-un1t-black text-sm font-medium disabled:opacity-50"
                >
      ...
      {fulfilled.length > 0 && (
        <section>
          ...
          <ul className="space-y-2">
            {fulfilled.map((r) => (
              <li key={r.id} className="text-sm text-un1t-subtle flex items-center gap-2">
