...
function NodeCard({ node }) {
  ...
  return (
    <div className="w-72 flex items-center gap-3 bg-un1t-surface border border-un1t-border rounded-lg px-4 py-3 shadow-sm">
  ...
  return (
    <>
      <div className="max-w-md mx-auto mb-4 rounded-lg border border-amber-500/30 bg-amber-500/[0.05] px-3 py-2 text-xs text-amber-700 flex items-center gap-2">
        ...
        This flow’s paths merge back together (a “diamond”), which the visual editor can’t edit yet — it’s read-only here. Rebuild it as separate branch paths to make it editable.
      </div>
    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      <div className="flex items-start justify-between gap-4 mb-1">
        <div className="min-w-0">
          ...
          <h1 className="text-xl font-semibold text-un1t-text truncate mt-1">{sequence?.name || 'Automation'}</h1>
        </div>
