...
describe('buildSessionReport', () => {
  ...
  it('flags the Burn (fixture: 600s Z4 + 300s Z5 = 15 min ≥ 12)', () => {
  ...
  it('gives an active member NO next_action (Pulse stays out of booking)', () => {
    // Fixture cta.stage is member (FUNNEL.1 slug) — the report must not
    // surface a book-class (or any) CTA to members. Glofox owns booking.
...
describe('buildNextAction', () => {
  // FUNNEL.1 slugs (mirrors un1t-crm shared copy — this file is canon).
